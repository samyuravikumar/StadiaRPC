...
(async function() {
    let gamesDbResponse = await fetch("https://github.com/samyuravikumar/StadiaRPC/blob/25f1c2e6213abbdeb1e964648e457bcbe14f30fe/masterdatagame.json");
    gamesDb = await gamesDbResponse.json();
    gamesDb = gamesDb["data"];

    let rpcDbResponse = await fetch("https://github.com/samyuravikumar/StadiaRPC/blob/25f1c2e6213abbdeb1e964648e457bcbe14f30fe/stadia.json");
    rpcDb = await rpcDbResponse.json();

    let response = await fetch("https://github.com/samyuravikumar/StadiaRPC/blob/25f1c2e6213abbdeb1e964648e457bcbe14f30fe/games.json");
